<%@ Page Title="ShipSetting" Language="C#" MasterPageFile="~/Web/headerFooter.Master" AutoEventWireup="true" CodeBehind="ShipSetting.aspx.cs" Inherits="WMS_v1._0.Web.Ship" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="CSS/Ship.css" rel="stylesheet" />
</asp:Content>
            ...
            <div class="list_item">
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdInput">
                            <select id="customer_name_c" name="customer_name_c">
                                <option>ALL</option>
                            </select>
                        </td>
                        <td class="tdLab">
        ...
        <div id="zindex">
            ...
            <div id="div_togger1">
                ...
                <div class="toggerBody">
                    <div>
                        <label>客户名称:</label>
                        <select id="insert_customer_name_c" name="insert_customer_name_c"></select>
                    </div>
                    <div>
                        <label>出货单号:</label>
                        <input type="text" runat="server" id="top_insert_ship_no" />
                        <input type="button" id="get_new_ship_no" onclick="getNew_ship_no()" value="新出货单号" />
                    </div>
                    <div>
                        <label>料号:</label>
                        <select id="insert_item_name_c" name="insert_item_name_c"></select>
                    </div>
                    <div>
                        <label>需求量:</label>
