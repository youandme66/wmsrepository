<%@ Page Title="PoStorage" Language="C#" MasterPageFile="~/Web/headerFooter.Master" AutoEventWireup="true" CodeBehind="PoStorage.aspx.cs" Inherits="WMS_v1._0.Web.PoStorage" %>
                ...
                <table class="tab">
                    ...
                    <tr>
                        ...
                        <td class="tdInput">
                            ...
                            <asp:DropDownList ID="frame_name" runat="server" AutoPostBack="True" />
                        </td>
