<%@ Page Title="DealDetialPDA" Language="C#" MasterPageFile="~/PDA/headerFooter.Master" AutoEventWireup="true" CodeBehind="DealDetialPDA.aspx.cs" Inherits="WMS_v1._0.PDA1.DealDetialPDA" %>
    ...
    <div class="list">
        <div class="list_top">
            <div class="list_item">
                <fieldset>
                    <legend>交易类别</legend>
                    <input type="radio" id="radio1" name="transaction_type" value="" runat="server" checked="" />
                    <label>全部</label>
                    <input type="radio" id="radio8" name="transaction_type" value="PoSuspense" runat="server" />
                    <label>PO暂收</label>
                    <input type="radio" id="radio2" name="transaction_type" value="PoInStorage" runat="server" />
                    <label>PO入库</label>
                    <input type="radio" id="radio3" name="transaction_type" value="Issue_Debit" runat="server" />
                    <label>领料单扣账</label>
                    <input type="radio" id="radio4" name="transaction_type" value="Return_Debit" runat="server" />
                    <label>退料单扣账</label>
                    <input type="radio" id="radio5" name="transaction_type" value="Exchange_Debit" runat="server" />
                    <label>调拨单扣账</label>
