<%@Page Title="ProgramsPDA"  Language="C#" AutoEventWireup="true" MasterPageFile="~/PDA/headerFooter.Master" CodeBehind="ProgramsPDA.aspx.cs" Inherits="WMS_v1._0.PDA.InteractionPDA" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <%--  <link rel="stylesheet" href="CSS/rackSettingPDA.css" />
    <link rel="stylesheet" href="CSS/warehouseSettingPDA.css" />--%>
</asp:Content>
            ...
            <div class="list_item">
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdInput">
                            <select class="InputStyle"  id="program_name_Query" name="program_name_Query">
                        ...
                        <td class="tdInput">
                            <select class="InputStyle" id="enabled_Query" name="enabled_Query">
                                <option value="">ALL</option>
                                <option>Y</option>
                                <option>N</option>
                            </select>
