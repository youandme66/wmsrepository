<%@ Page Title="领料单打印" Language="C#"  MasterPageFile="~/Web/headerFooter.Master"  AutoEventWireup="true"  EnableEventValidation="false"  CodeBehind="materialRequisitionOperation.aspx.cs" Inherits="WMS_v1._0.Web.materialRequisitionOperation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="CSS/materialRequisitionOperation.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="list">
                ...
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdLab" style="display:none" >
                               <input type="text" runat="server" id="REQUIRED_QTY2" />
                            <input type="text" runat="server" id="issue_no_search" />
                        </td>
                        </tr>
                </table>
            </div>
        ...
        <div class="list_foot">
         ...
         <div class="list_foot"   style="display :none;">
            <asp:Repeater ID="issue2" runat="server">
                <HeaderTemplate>
                    <table id="Line_Table" class="mGrid" border="1">
                        <tr>
                            <th>领料ID</th>
