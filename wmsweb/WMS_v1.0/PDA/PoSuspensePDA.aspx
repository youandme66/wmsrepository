<%@ Page Title="PoSuspensePDA" Language="C#" MasterPageFile="~/PDA/headerFooter.Master" AutoEventWireup="true" CodeBehind="PoSuspensePDA.aspx.cs" Inherits="WMS_v1._0.PDA.PoSuspensePDA" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%--    <link rel="stylesheet" href="CSS/PoStoragePDA.css" />--%>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="list">
        <div class="list_top">
            <div class="list_top_picture">
                <button id="Button1" class="btn_style" type="button" runat="server" onserverclick="ClearALLMessage_Click">
            ...
            <div class="list_item">
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdInput">
                            <asp:DropDownList class="selectInput" ID="po_no" runat="server" AutoPostBack="True" />
                        </td>
                        <td class="tdLab">
                            <label>Line序号</label>
                        </td>
                        <td class="tdInput">
                            <asp:DropDownList class="selectInput" ID="line_num" runat="server" />
                        </td>
                        <td class="tdLab">
                    ...
                    <tr>
                        ...
                        <td class="tdInput">
                            <input type="text" id="vendor_name" runat="server" disabled="disabled" />
                        </td>
                        <td class="tdLab">
                            <label>收料量</label>
                        </td>
                ...
                <div class="list_item">
                    <table class="tab">
                        <tr>
                            ...
                            <td class="tdLab">
                                <input id="Button2" type="button" class="selectBtn" value="查询" runat="server" onserverclick="SerchReceive_mtl_Click" />
