<%@ Page Title="workOrderSettingPDA" Language="C#" MasterPageFile="~/PDA/headerFooter.Master" AutoEventWireup="true" CodeBehind="workOrderSettingPDA.aspx.cs" Inherits="WMS_v1._0.PDA.workOrderSettingPDA" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%--    <link rel="stylesheet" href="CSS/workOrderSettingPDA.css" />--%>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="list">
        <div class="list_top">
            <div class="list_top_picture">
                <button id="Button1" class="btn_style"  type="button" runat="server" onserverclick="CleanAllMeassage">
    ...
    <div id="zindex">
        <div id="div_togger1">
            ...
            <div class="toggerFooter">
                <asp:Button ID="Button3" runat="server" CssClass="btn_close" Text="确定" OnClick="Insert" />
        ...
        <div id="div_togger2">
            ...
            <div class="toggerFooter">
                <asp:Button ID="Button4" runat="server" OnClick="update" Text="确定" />
        ...
        <div id="div_togger3">
            ...
            <div class="toggerFooter">
                <asp:Button ID="Button7" runat="server" OnClick="delete" Text="确定" />
