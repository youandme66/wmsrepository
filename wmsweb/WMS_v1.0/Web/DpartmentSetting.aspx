<%@ Page Title="" Language="C#" MasterPageFile="~/Web/headerFooter.Master" AutoEventWireup="true" CodeBehind="DpartmentSetting.aspx.cs" Inherits="WMS_v1._0.Web.DpartmentSetting" %>
                ...
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdLab">
                            <label>部门名称</label></td>
                        <td class="tdInput">
                           <select runat="server" id="description_select">
                           <option value=""></option> 
                           </select>
                        ...
                        <td class="tdInput">
                            <select runat="server" id="enabled_select">  
                                <option value=""></option>                          
