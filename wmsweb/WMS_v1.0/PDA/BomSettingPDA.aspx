<%@ Page Title="BomSettingPDA" Language="C#" MasterPageFile="~/PDA/headerFooter.Master" AutoEventWireup="true" CodeBehind="BomSettingPDA.aspx.cs" Inherits="WMS_v1._0.PDA1.BomSettingPDA" %>
    ...
    <div id="zindex">
        <div id="div_togger1">
            ...
            <div class="toggerFooter">
                <asp:Button ID="Button2" runat="server" OnClick="InsertMeassage_Click" Text="确定"/>
                 <asp:Button ID="Button3" runat="server" OnClick="CleanInsertMessage" Text="取消"/>
            </div>
        </div>
        ...
        <div id="div_togger2">
            ...
            <div class="toggerFooter"> 
                 ...
                 <asp:Button ID="Button4" runat="server" OnClick="CleanUpdateMessage" Text="取消"/>
            </div>
        </div>
