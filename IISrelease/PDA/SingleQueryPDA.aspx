<%@ Page Title="SingleQueryPDA" Language="C#" MasterPageFile="~/PDA/headerFooter.Master" AutoEventWireup="true" CodeBehind="SingleQueryPDA.aspx.cs" Inherits="WMS_v1._0.PDA.SingleQueryPDA" %>
            ...
            <div class="list_item">
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdInput">
                            <input class="InputStyle" id="singlequery_return_wo_id" type="text" runat="server" />
                        </td>
                        <td class="tdLab">
                            <label>单位</label>
                        </td>
                        <td class="tdInput">
                            <input class="InputStyle" id="singlequery_uom_id" type="text" runat="server" />
                        ...
                        <td class="tdInput">
                            <asp:DropDownList class="InputStyle" ID="seq_operation_num1" runat="server"  AutoPostBack="false"></asp:DropDownList>
                        </td>
                        <td class="tdLab">
                            <label>库别</label>
                        </td>
                        <td class="tdInput">
                            <asp:DropDownList class="InputStyle" ID="Subinventory1" runat="server" Height="25px" AutoPostBack="true" OnSelectedIndexChanged="Subinventory1_SelectedIndexChanged"></asp:DropDownList>
                        </td>
                        <td class="tdLab">
                            <label>区域</label>
                        </td>
                        <td class="tdInput">
                            <asp:DropDownList class="InputStyle" ID="DropDownList2" runat="server" Height="25px" AutoPostBack="false"></asp:DropDownList>
                        </td>
                        <td class="tdLab">
                            <asp:Button  ID="singlequery_id" runat="server" Text="查询单身" OnClick="select_singlequery" />
                        </td>
                    </tr>
                </table>
            </div>
