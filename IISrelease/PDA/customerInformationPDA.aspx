<%@ Page Title="customerInformationPDA" Language="C#" MasterPageFile="~/PDA/headerFooter.Master" AutoEventWireup="true" CodeBehind="customerInformationPDA.aspx.cs" Inherits="WMS_v1._0.PDA1.customerInformationPDA" %>
    ...
    <div id="zindex">
        ...
        <div id="div_togger2">
            ...
            <div class="toggerFooter">
                ...
                <button id="Button1" class="btn_close" type="button" runat="server">取消</button>
            </div>
        </div>
