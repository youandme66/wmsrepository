<%@ Page Title="" Language="C#" MasterPageFile="~/PDA/headerFooter.Master" AutoEventWireup="true" CodeBehind="ReinspectionOperationPDA.aspx.cs" Inherits="WMS_v1._0.PDA.ReinspectionOperationPDA" %>
                ...
                <div class="list_item">
                    <table class="tab">
                        <tr>
                            ...
                            <td class="tdInput">
                                <select id="frame_name_reinspect" class="selectInput" name="frame_name_reinspect">
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="tdInput">
                                <select id="reinspect_select" class="selectInput" name="reinspect_select" runat="server">
