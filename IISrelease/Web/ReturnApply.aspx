<%@ Page Title="" Language="C#" MasterPageFile="~/Web/headerFooter.Master" AutoEventWireup="true" CodeBehind="ReturnApply.aspx.cs" Inherits="WMS_v1._0.Web.ReturnApply" %>
            ...
            <div class="list_item">
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdInput">
                            <select id="return_type" name="return_type" class="select_text">
                    ...
                    <tr>
                        ...
                        <td class="tdInput">
                            <asp:DropDownList ID="DropDownList_return_wo_no" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownList_return_wo_no_SelectedIndexChanged" />
                        </td>
                        <td class="tdLab">
                            <label>料号</label>
                        </td>
                        ...
                        <td class="tdInput">
                            <asp:DropDownList ID="DropDownList_return_sub_key" runat="server" />
                        </td>
                        <td class="tdLab">
                            <label>制程</label>
                        </td>
        ...
        <div class="list_foot">
            <div class="foot_zb">
                <div class="zb_left">
                    ...
                    <input id="Botton_Commit_All_Return_Line" type="button" style="width: 200px; margin-right: 20px;" class="input_btn" value="提交所有单身" runat="server" onserverclick="Commit_All_Return_Line" />
