<%@ Page Title="PoReturnPDA" Language="C#" MasterPageFile="~/PDA/headerFooter.Master" AutoEventWireup="true" CodeBehind="PoReturnPDA.aspx.cs" Inherits="WMS_v1._0.PDA.PoReturnPDA" %>
            ...
            <div class="list_item">
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdInput">
                            <asp:DropDownList class="selectInput" ID="DropDownList1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" />
                        </td>
                        <td class="tdLab">
                            <label>区域:</label>
                        </td>
                        <td class="tdInput">
                            <asp:DropDownList class="selectInput" ID="DropDownList2" runat="server" />
                        </td>
                        <td class="tdLab">
                            <label>退回量:</label>
                        </td>
