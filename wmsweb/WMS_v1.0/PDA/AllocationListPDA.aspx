<%@ Page Title="AllocationListPDA" Language="C#" MasterPageFile="~/PDA/headerFooter.Master" AutoEventWireup="true" CodeBehind="AllocationListPDA.aspx.cs" Inherits="WMS_v1._0.PDA.AllocationListPDA" %>
            ...
            <div class="list_item">
                <table class="tab">
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="Button4" type="button" value="添加" runat="server" onserverclick="AddMeassage_Clisk1" />
                        </td>
                    </tr>
                    <tr>
                        <%--                        <td>
                            ...
                            <td>
                                <div class="list_item">
                                    <table class="tab">
                                        <tr>
                                            <td>
                                                <input id="Button5" type="button" value="添加" runat="server" onserverclick="AddMeassage_Clisk" /></td>
                                        </tr>
                                        <%--                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <input id="Button6" type="button" value="提交" runat="server" onserverclick="CommitMessage_Click" /></td>
                                        </tr>
                                    </table>
                                </div>
                            </td>
