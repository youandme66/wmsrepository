...
{
    public partial class ExchangeQueryPDA : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //DataSet ds_item_name = invoiceDC.getItem_name(2);
        ...
        protected void Select(object sender, EventArgs e)
        {
            try
            {
                ...
                GridView_header.DataSource = invoiceDC.getExchangeHeaderBySome(Invoice_no, "");
                GridView_line.DataSource = invoiceDC.getExchangeLineBySome(Invoice_no, Item_name, start_time, end_time);
