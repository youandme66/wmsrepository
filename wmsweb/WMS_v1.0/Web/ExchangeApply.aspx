<%@ Page Title="调拨单申请" Language="C#" MasterPageFile="~/Web/headerFooter.Master" AutoEventWireup="true" CodeBehind="ExchangeApply.aspx.cs" Inherits="WMS_v1._0.Web.ExchangeApply" %>
            ...
            <div class="list_item">
                <table class="tab">
                    ...
                    <%--    <td class="tdLab">
                        ...
                        <td class="tdInput">
                            <asp:DropDownList ID="DropDownList_out_subinventory" runat="server" AutoPostBack="true"  OnSelectedIndexChanged="DropDownList_out_subinventory_SelectedIndexChanged"/>
                        </td>
                        <td class="tdLab">
                            <label>料号</label>
                        </td>
                       ...
                       <%-- <td class="tdLab">
                        ...
                        <td class="tdInput">
                            <asp:DropDownList ID="DropDownList_in_subinventory" runat="server" />
                        </td>
                        <td class="tdLab">
                            <label>制程</label>
                        </td>
        ...
        <div class="list_foot">
            <div class="foot_zb">
                <div class="zb_left">
                    ...
                    <input id="Button4" type="button" style="width: 200px; margin-right: 20px;" class="input_btn" value="提交所有单身" runat="server" onserverclick="Commit_All_Exchange_Line" />
