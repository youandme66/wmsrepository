<%@ Page Title="areaSetting" Language="C#" MasterPageFile="~/Web/headerFooter.Master" AutoEventWireup="true" CodeBehind="areaSetting.aspx.cs" Inherits="WMS_v1._0.Web.areaSetting" %>
            ...
            <div class="list_item">
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdInput">
                            <select id="enabled" runat ="server" >
                                <option >ALL</option>
                                <option>Y</option>
                                <option>N</option>                              
                            </select>
                        ...
                        <td class="tdLab">
                            <label>库别名</label></td>
                        <td class="tdInput">
                            <select id ="subinventory_name" name="subinventory_name"  >
                                <option >ALL</option>
                            </select>                         
                        </td>
                        <td class="tdLab">
