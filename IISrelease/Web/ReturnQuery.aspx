<%@ Page Title="退料单查询" Language="C#" MasterPageFile="~/Web/headerFooter.Master" AutoEventWireup="true" CodeBehind="ReturnQuery.aspx.cs" Inherits="WMS_v1._0.Web.ReturnQuery" %>
        ...
        <div class="list_foot">
            ...
            <asp:GridView
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="return_wo_no" HeaderText="退料工单号" />
                    <asp:BoundField DataField="operation_seq_num_name" HeaderText="制程代号" />
                    <asp:BoundField DataField="ITEM_NAME" HeaderText="料号" />
                    <asp:BoundField DataField="return_sub_name" HeaderText="库别" />
                    <asp:BoundField DataField="frame_key" HeaderText="料架" />
                    <asp:BoundField DataField="return_qty" HeaderText="退料数量" />
                    <asp:BoundField DataField="flag" HeaderText="扣账状态" />
