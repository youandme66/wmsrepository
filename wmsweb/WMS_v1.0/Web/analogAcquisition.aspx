<%@ Page Title="analogAcquisition" Language="C#" MasterPageFile="~/Web/headerFooter.Master" AutoEventWireup="true" CodeBehind="analogAcquisition.aspx.cs" Inherits="WMS_v1._0.Web.analogAcquisition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="list">
        <div class="list_top">
            <asp:Panel DefaultButton="add_wo_no" runat="server">
                <div class="section-top">
                    ...
                    <div class="inputBtn">
                        <asp:Button style="width: 50px" runat="server" Text="查询" OnClick="select_one_simulate"></asp:Button>
                    </div>
                    <div class="inputBtn">
