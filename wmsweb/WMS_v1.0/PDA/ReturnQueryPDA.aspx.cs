...
{
    public partial class ReturnQueryPDA : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                //    DataSet ds_Invoice_no = invoiceDC.getInvoice_no(1);
                //    DataSet ds_item_name = invoiceDC.getItem_name(1);
        ...
        protected void Select(object sender, EventArgs e)
        {
            try
            {
                ...
                GridView_header.DataSource = invoiceDC.getReturnHeaderBySome(Invoice_no, Return_type, "");
                GridView_line.DataSource = invoiceDC.getReturnLineBySome(Invoice_no, Item_name, Return_type, start_time, end_time);
