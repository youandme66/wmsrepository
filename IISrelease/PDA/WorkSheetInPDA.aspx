<%@ Page Title="WorkSheetInPDA" Language="C#" MasterPageFile="~/PDA/headerFooter.Master" AutoEventWireup="true" CodeBehind="WorkSheetInPDA.aspx.cs" Inherits="WMS_v1._0.PDA.WorkSheetInPDA" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%--<link rel="stylesheet" href="CSS/worksheetInPDA.css" />--%>
</asp:Content>
    ...
    <div class="list">
        <div class="list_top">
            <div class="list_top_picture">
                <button id="Button1" class="btn_style"  type="reset" runat="server" onserverclick="cleanup">
                    <%--<img src="icon/clear.png" /><br />--%>
                    清除
                </button>
                 <asp:ScriptManager ID="ScriptManager2" runat="server"></asp:ScriptManager>
                <button id="Button3" class="btn_style"  type="button" runat="server" onserverclick="search">
                ...
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdLab" style="text-align: center;">
                            <button id="Button4" class="tdBtu" type="button" runat="server" onserverclick="workSheetIn">入库</button>
                        </td>
