...
for (var i = 0; i < btn_update.length; i++) {
    ...
    btn_update[i].onclick = function () {
        ...
        document.getElementById("unique_id2").value = td[0].innerHTML;
        document.getElementById("pn_head2").value = td[1].innerHTML;
        document.getElementById("reinspect_week2").value = td[2].innerHTML;
