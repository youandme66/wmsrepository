<%@ Page Title="" Language="C#" MasterPageFile="~/Web/headerFooter.Master" AutoEventWireup="true" CodeBehind="returnOrder.aspx.cs" Inherits="returnOrder.returnOrder" %>
                ...
                <table class="tab">
                    ...
                    <tr>
                        ...
                        <td class="tdLab" style="margin-left: 40px;">
                            <input type="button" runat="server" value="提交单头" onserverclick="insert1" />
                        </td>
                    </tr>
                </table>
            </div>
