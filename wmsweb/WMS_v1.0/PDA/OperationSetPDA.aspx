<%@ Page Title="OperationSetPDA" Language="C#" MasterPageFile="~/PDA/headerFooter.Master" AutoEventWireup="true" CodeBehind="OperationSetPDA.aspx.cs" Inherits="WMS_v1._0.PDA.OperationSetPDA" %>
                ...
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdLab" style="text-align: center;">
                            <asp:Button ID="Button1" Class="buttonStyle" runat="server" OnClick="Select" Text="查询" />
