<%@ Page Title="rackSetting" Language="C#" MasterPageFile="~/Web/headerFooter.Master" AutoEventWireup="true" CodeBehind="rackSetting.aspx.cs" Inherits="WMS_v1._0.Web.rackSetting" %>
            ...
            <div class="list_item">
                <table class="tab">
                    ...
                    <tr>
                        ...
                        <td class="tdLab">
                            <asp:Button CssClass="selectBtn" runat="server" OnClick="Select" Text="查询" />
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <asp:Repeater ID="Line_Repeater" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <button class="btn_update" runat="server" type="button">更新</button></td>
                        <td>
                            <button class="btn_delete" runat="server" type="button">删除</button></td>
                    </tr>
                </ItemTemplate>
    ...
    <div id="zindex">
        <div id="div_togger1">
            ...
            <div class="toggerBody">
                ...
                <div>
                    ...
                    <asp:DropDownList ID="Region_key" runat="server"></asp:DropDownList>
            ...
            <div class="toggerFooter">
                <asp:Button runat="server" OnClick="Insert" Text="确定" />
        ...
        <div id="div_togger2">
            ...
            <div class="toggerBody">
                ...
                <div>
                    <label>区域:</label>
                    <asp:DropDownList ID="Region_key2" runat="server"></asp:DropDownList>
                </div>
                <div>
                    <label>描述:</label>
            ...
            <div class="toggerFooter">
                <asp:Button OnClick="Update" runat="server" Text="确定" />
                <button class="btn_close" type="button">取消</button>
            </div>
        </div>
        ...
        <div id="div_togger3">
            ...
            <div class="toggerFooter">
                <asp:Button runat="server" OnClick="Delete" Text="确定" />
                <button class="btn_close" type="button">取消</button>
            </div>
        </div>
    </div>
