...
$(document).ready(function () {
    $.ajax({
        ...
        dataType: "json",
        data: {
            warehouse: $("#Department2").val(),
        },
        success: function (data) {
            for (var i = 0; i < data.length; i++) {
                $("#Department2").append("<option>" + data[i].Name + "</option>");
            }
        }
    });
});
...
$(document).ready(function () {
    $.ajax({
        ...
        dataType: "json",
        data: {
            warehouse: $("#Department").val(),
        },
        success: function (data) {
            for (var i = 0; i < data.length; i++) {
                $("#Department").append("<option>" + data[i].Name + "</option>");
            }
        }
    });
});