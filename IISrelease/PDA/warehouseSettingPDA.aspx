<%@ Page Title="warehouseSettingPDA" Language="C#" MasterPageFile="~/PDA/headerFooter.Master" AutoEventWireup="true" CodeBehind="warehouseSettingPDA.aspx.cs" Inherits="WMS_v1._0.PDA.warehouseSettingPDA" %>
            ...
            <div class="list_item">
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdInput">
                            <select class="InputStyle" id="subinventory_name_Query" name="subinventory_name_Query">
                        ...
                        <td class="tdInput">
                            <select class="InputStyle" id="enabled" name="enabled_Query">
                                <option value="">ALL</option>
                                <option>Y</option>
                                <option>N</option>
                            </select>
