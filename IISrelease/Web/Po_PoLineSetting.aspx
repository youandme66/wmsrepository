<%@ Page Title="Po_PoLineSetting" Language="C#" MasterPageFile="~/Web/headerFooter.Master" AutoEventWireup="true" CodeBehind="Po_PoLineSetting.aspx.cs" Inherits="WMS_v1._0.Web.Po_PoLineSetting" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="CSS/Po_PoLine.css" rel="stylesheet" />
</asp:Content>
                ...
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdLab">
                            <label>厂商代码</label></td>
                        <td class="tdInput">
                            <asp:DropDownList ID="vendor_keys" runat="server">
                            </asp:DropDownList>
                        </td>
...
<%--                <div>
        ...
        <div id="div_togger6">
            ...
            <div class="toggerBody">
                <div>
                    <label>PO单号:</label>
                    <input id="po_no_Delet_poLine" class="input_text" runat="server" readonly="readonly" type="text" /> <label>Line序号:</label>
            ...
            <div class="toggerFooter">
                <asp:Button ID="Button1" runat="server" Text="确定" OnClick="DeletPO_Line_Click" />
                <button class="btn_close" type="button">取消</button>
            </div>
        </div>
