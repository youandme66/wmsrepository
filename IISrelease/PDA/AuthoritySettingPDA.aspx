<%@ Page Title="AuthoritySettingPDA" Language="C#" MasterPageFile="~/PDA/headerFooter.Master" AutoEventWireup="true" CodeBehind="AuthoritySettingPDA.aspx.cs" Inherits="WMS_v1._0.PDA.AuthoritySettingPDA" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <%--   <link rel="stylesheet" href="CSS/BomSettingPDA.css" />--%>
</asp:Content>
    ...
    <div class="list">
        <div class="list_top">
            <div class="list_top_picture">
                <button id="Button1" class="btn_style" type="button" runat="server" onserverclick="CleanAllMeassage_Click">
            ...
            <div class="list_item">
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdInput">
                            <select class="selectInput" id="user_id_Authority" name="user_id_Authority">
                                <option></option>
                            </select>
                        </td>
                        ...
                        <td class="tdInput">
                            <select class="selectInput" id="program_id_Authority" name="program_id_Authority">
                                <option></option>
                            </select>
                        </td>
                        <td class="tdLab">
                        ...
                        <td class="tdInput">
                            <select class="selectInput" runat="server" id="select_id_Authority">
                                <option value=""></option>
