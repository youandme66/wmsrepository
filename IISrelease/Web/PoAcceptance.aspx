<%@ Page Title="PoAcceptance" Language="C#" MasterPageFile="~/Web/headerFooter.Master" AutoEventWireup="true" CodeBehind="PoAcceptance.aspx.cs" Inherits="WMS_v1._0.Web.PoAcceptance" %>
            ...
            <div class="list_item">
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdLab">
                            <button id="Button1" class="selectBtn" type="button" runat="server" onserverclick="QueryMessage_Click">确定</button>
                        </td>
                    </tr>
                </table>
            </div>
