<%@ Page Title="customerSettingPDA" Language="C#" MasterPageFile="~/PDA/headerFooter.Master" AutoEventWireup="true" CodeBehind="customerSettingPDA.aspx.cs" Inherits="WMS_v1._0.PDA1.customerSettingPDA" %>
            ...
            <div class="list_item">
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdInput">
                            <select class="selectInput" id="Select1"   name="Select1">
                                 <option></option>
                            </select>
                        </td>
                        <td class="tdLab">
                        ...
                        <td class="tdInput">
                            <textarea class="selectInput" runat="server" id="Textarea1" ></textarea>
                        </td>
                        <td class="tdLab">
