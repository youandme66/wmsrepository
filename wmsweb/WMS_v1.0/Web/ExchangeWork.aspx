<%@ Page Title="调拨单作业" Language="C#" MasterPageFile="~/Web/headerFooter.Master" AutoEventWireup="true" CodeBehind="ExchangeWork.aspx.cs" Inherits="WMS_v1._0.Web.ExchangeWork" %>
            ...
            <div class="list_item">
                <table class="tab">
                    <tr>
                        ...
                        <td class="tdInput">
                            <asp:DropDownList ID="DropDownList_invoice_no" runat="server" AutoPostBack="true" />
                        </td>
                        <td class="tdLab">
